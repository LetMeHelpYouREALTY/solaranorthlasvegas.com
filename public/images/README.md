...
| `community/` | Area / lifestyle shots for neighborhood pages (not MLS listing photos without permission). |
...
- **Rights:** MLS photos only with written permission; model/property releases for marketing imagery.
